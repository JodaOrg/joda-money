...
[Release 0.10.0](download.html) is the current development release intended for feedback.
...
Available in [Maven Central](http://search.maven.org/#artifactdetails%7Corg.joda%7Cjoda-money%7C0.10.0%7Cjar).
