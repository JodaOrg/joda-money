...
public class TestBigMoney {
    ...
    public void test_factory_of_String_BigDecimal_badCurrency() {
        BigMoney.of("GBX", BIGDEC_2_345);
    }

    @Test(expectedExceptions = NullPointerException.class)
    public void test_factory_of_String_BigDecimal_nullCurrency() {
        BigMoney.of((String) null, BIGDEC_2_345);
    }
    ...
    public void test_factory_ofCurrencyScale_Currency_BigDecimal_RoundingMode_DOWN() {
        BigMoney test = BigMoney.ofCurrencyScale(JPY, BIGDEC_2_34, RoundingMode.DOWN);
    ...
    public void test_factory_ofCurrencyScale_Currency_BigDecimal_RoundingMode_UP() {
        BigMoney test = BigMoney.ofCurrencyScale(JPY, BIGDEC_2_34, RoundingMode.UP);
        assertEquals(test.getCurrencyUnit(), JPY);
    ...
    public void test_factory_ofCurrencyScale_String_BigDecimal_RoundingMode_badCurrency() {
        BigMoney.ofCurrencyScale("GBX", BIGDEC_2_34, RoundingMode.DOWN);
    }

    @Test(expectedExceptions = NullPointerException.class)
    public void test_factory_ofCurrencyScale_String_BigDecimal_RoundingMode_nullCurrency() {
        BigMoney.ofCurrencyScale((String) null, BIGDEC_2_34, RoundingMode.DOWN);
    }
    ...
    public void test_withScale_int_less() {
        BigMoney test = BigMoney.parse("GBP 2.34").withScale(1);
        assertEquals(test.getAmount(), bd("2.3"));
        assertEquals(test.getScale(), 1);
    }

    public void test_withScale_int_more() {
        BigMoney test = BigMoney.parse("GBP 2.34").withScale(3);
    ...
    public void test_withScale_intRoundingMode_less() {
        BigMoney test = BigMoney.parse("GBP 2.34").withScale(1, RoundingMode.UP);
        assertEquals(test.getAmount(), bd("2.4"));
        assertEquals(test.getScale(), 1);
    }

    public void test_withScale_intRoundingMode_more() {
        BigMoney test = BigMoney.parse("GBP 2.34").withScale(3, RoundingMode.UP);
        assertEquals(test.getAmount(), bd("2.340"));
        assertEquals(test.getScale(), 3);
    }
    ...
    public void test_withCurrencyScale_int_less() {
        BigMoney test = BigMoney.parse("GBP 2.345").withCurrencyScale();
        assertEquals(test.getAmount(), bd("2.34"));
        assertEquals(test.getScale(), 2);
    }
    ...
    public void test_withCurrencyScale_int_lessJPY() {
        BigMoney test = BigMoney.parse("JPY 2.345").withCurrencyScale();
    ...
    public void test_plus_BigMoneyProvider_Money() {
        BigMoney test = GBP_2_34.plus(Money.ofMinor(GBP, 1));
...
//        BigMoney test = GBP_2_34.plus(BigDecimal.ZERO, RoundingMode.UNNECESSARY);
//        assertSame(test, GBP_2_34);
//    }
//
//    public void test_plus_BigDecimalRoundingMode_positive() {
//        BigMoney test = GBP_2_34.plus(bd("1.23"), RoundingMode.UNNECESSARY);
//        assertEquals(test.toString(), "GBP 3.57");
//    }
//
...
//        BigMoney test = GBP_2_34.plus(bd("1.235"), RoundingMode.DOWN);
//        assertEquals(test.toString(), "GBP 3.57");
//    }
//
//    @Test(expectedExceptions = ArithmeticException.class)
//    public void test_plus_BigDecimalRoundingMode_roundUnecessary() {
//        GBP_2_34.plus(bd("1.235"), RoundingMode.UNNECESSARY);
//    }
//
//    @Test(expectedExceptions = NullPointerException.class)
...
//        BigMoney test = GBP_2_34.plus(0d, RoundingMode.UNNECESSARY);
//        assertSame(test, GBP_2_34);
//    }
//
//    public void test_plus_doubleRoundingMode_positive() {
//        BigMoney test = GBP_2_34.plus(1.23d, RoundingMode.UNNECESSARY);
//        assertEquals(test.toString(), "GBP 3.57");
//    }
//
...
//        BigMoney test = GBP_2_34.plus(1.235d, RoundingMode.DOWN);
//        assertEquals(test.toString(), "GBP 3.57");
//    }
//
//    @Test(expectedExceptions = ArithmeticException.class)
...
//
    ...
    public void test_minus_BigMoneyProvider_Money() {
        BigMoney test = GBP_2_34.minus(Money.ofMinor(GBP, 1));
...
//        BigMoney test = GBP_2_34.minus(BigDecimal.ZERO, RoundingMode.UNNECESSARY);
//        assertSame(test, GBP_2_34);
//    }
//
//    public void test_minus_BigDecimalRoundingMode_positive() {
//        BigMoney test = GBP_2_34.minus(bd("1.23"), RoundingMode.UNNECESSARY);
//        assertEquals(test.toString(), "GBP 1.11");
//    }
//
...
//        BigMoney test = GBP_2_34.minus(bd("1.235"), RoundingMode.DOWN);
//        assertEquals(test.toString(), "GBP 1.10");
//    }
//
//    @Test(expectedExceptions = ArithmeticException.class)
//    public void test_minus_BigDecimalRoundingMode_roundUnecessary() {
//        GBP_2_34.minus(bd("1.235"), RoundingMode.UNNECESSARY);
//    }
//
//    @Test(expectedExceptions = NullPointerException.class)
...
//        BigMoney test = GBP_2_34.minus(0d, RoundingMode.UNNECESSARY);
//        assertSame(test, GBP_2_34);
//    }
//
//    public void test_minus_doubleRoundingMode_positive() {
//        BigMoney test = GBP_2_34.minus(1.23d, RoundingMode.UNNECESSARY);
//        assertEquals(test.toString(), "GBP 1.11");
//    }
//
...
//        BigMoney test = GBP_2_34.minus(1.235d, RoundingMode.DOWN);
//        assertEquals(test.toString(), "GBP 1.10");
//    }
//
//    @Test(expectedExceptions = ArithmeticException.class)
...
//
    ...
    // toBigBigMoney()
    //-----------------------------------------------------------------------
    public void test_toBigBigMoney() {
        assertSame(GBP_2_34.toBigMoney(), GBP_2_34);
    }

    //-----------------------------------------------------------------------
    // isSameCurrency(BigMoney)
    //-----------------------------------------------------------------------
    ...
    @Test(expectedExceptions = NullPointerException.class)
    public void test_isSameCurrency_BigMoney_nullBigMoney() {
    ...
    public void test_compareTo_BigBigMoney() {
        BigMoney t = GBP_2_35;
